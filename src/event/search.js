...
exports.search = {
    ...
    Lirik2: function (search) {
        return __awaiter(this, void 0, void 0, function () {
            var google, rus, ros, _i, rus_1, g, data, $, lk, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        google = require('google-it');
                        return [4 /*yield*/, google({ query: "lyrics ".concat(search, " genius") })];
                    case 1:
                        rus = _a.sent();
                        ros = [];
    ...
    Google: function (search) {
        return __awaiter(this, void 0, void 0, function () {
            var google, hasil, err_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        google = require('google-it');
                        return [4 /*yield*/, google({ query: search })];
                    case 1:
                        hasil = _a.sent();
            ...
            return __generator(this, function (_a) {
                try {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            gis(search, function (error, result) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    if (error) {
